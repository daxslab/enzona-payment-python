...
from enzona_payment.models.payment_full_operations import PaymentFullOperations  # noqa: E501
...
class TestPaymentFullOperations(unittest.TestCase):
    ...
    def testPaymentFullOperations(self):
        ...
        # model = enzona_payment.models.payment_full_operations.PaymentFullOperations()  # noqa: E501
        pass
